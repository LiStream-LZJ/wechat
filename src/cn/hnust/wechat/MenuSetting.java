...
public class MenuSetting {
	...
	public static String appId = "wx2199b9516d92de3c";
    public static String appSecret= "973b869fb06c8d61ed381c057b8084b4"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://hsjgh9.natappfree.cc/weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
